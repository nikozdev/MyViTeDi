...
local vLazySpec = {
    ...
    },
    {
        ...
        dependencies = {
            {
                ...
                ft = { 'org' },
                opts = {
                    org_agenda_files = vim.fn.stdpath("data") .. "/org-roam.nvim/**/*",
                    org_default_notes_file = vim.fn.stdpath("data") .. "/org-roam.nvim/notebook.org",
                },
                config = true,
            },
        },
        ...
        opts = {
            directory = vim.fn.stdpath("data") .. "/org-roam.nvim",
            bindings = {
            ...
            extensions = {
                dailies = {
                    directory = 'liva',
                    bindings = {
                        capture_date = "<LocalLeader>nd",
                        capture_today = "",
                        capture_yesterday = "",
                        capture_tomorrow = "",
                        goto_date = "<LocalLeader>nd",
                        goto_prev_date = "<LocalLeader>n[",
                        goto_next_date = "<LocalLeader>n]",
                        goto_today = "",
                        goto_yesterday = "",
                        goto_tomorrow = "",
                        find_directory = "",
