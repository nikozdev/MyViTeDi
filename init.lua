...
local vLazySpec = {
    ...
    },
    {
        ...
        lazy = true,
        keys = {
            { '<leader>zo', '<cmd>ObsidianOpen<cr>', desc = "Obsidian Open page;" },
            { '<leader>zf', '<cmd>ObsidianQuickSwitch<cr>', desc = "Obsidian Find page;" },
            { '<leader>zd', '<cmd>ObsidianToday<cr>', desc = "Obsidian Diary page for today;" },
            { '<leader>zl', '<cmd>ObsidianLink<cr>', desc = "Obsidian Link the selected text to a page;" },
            { '<leader>zn', '<cmd>ObsidianNewFromTemplate<cr>', desc = "Obsidian New page;" },
            { '<leader>zt', '<cmd>ObsidianTemplate<cr>', desc = "Obsidian Template;" },
            { '<leader>zi', '<cmd>ObsidianPasteImg<cr>', desc = "Obsidian PasteImage;" },
            { '<leader>zr', '<cmd>ObsidianRename<cr>', desc = "Obsidian Rename;" },
        },
        opts = {
            workspaces = {
                {
